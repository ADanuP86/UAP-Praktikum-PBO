...
public class ContactBrowser extends Application {
   ...
   private final String[] propertyName = {"id",
      ...
      "profession"};
   private final String[] propertyLabel = {"ID",
   ...
   private final ObservableList<ContactPerson> observableNames;
   private final FilteredList<ContactPerson> filteredData;
   private final SortedList<ContactPerson> sortedData;
   ...
   public void start(Stage primaryStage) {
      ...
      listView.getSelectionModel()
         ...
         .addListener((ObservableValue<? extends
                 ContactPerson> observable, ContactPerson oldValue, ContactPerson newValue) -> {
             if (observable != null &&
